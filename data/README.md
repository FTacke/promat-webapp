...
- `alignment/` enthaelt TextGrid-Dateien und spaetere reduzierte Alignment-JSONs der Gesamtaufnahme wie `alignment/isolated_speech.json`.
...
- die vorhandenen Beispiel-WAVs sind fachlich `source` und liegen deshalb unter `source/isolated_speech.wav`
