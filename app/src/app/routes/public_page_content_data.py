    ...
    "sections": [
        {
            ...
            "paragraphs_html": {
                "de": [
                    ...
                    "Diese Ausrichtung steht in einem größeren fachlichen Zusammenhang: Aussprache im Fremdsprachenunterricht wird inzwischen auch in der universitären Lehre und Forschung zur spanischen Phonetik und Phonologie ausdrücklich mitgedacht. Pustka (2021) widmet dem Thema bereits zu Beginn ihrer korpuslinguistischen Einführung ein eigenes Kapitel; in der zweiten, überarbeiteten Auflage von Gabriel/Meisenburg/Selig (2025) kommt erstmals ein eigenes Kapitel zu „Spanisch als Fremdsprache im deutschsprachigen Kontext“ hinzu, mit Abschnitten zu segmentalen Aspekten und Prosodie. <em>Pronunciation Matters</em> knüpft an diese Entwicklung an und ergänzt sie um eine Plattform, die kontrolliert erhobene Lernendendaten für empirische Untersuchungen und didaktische Anschlussfragen zugänglich macht.",
                ...
                "en": [
                    ...
                    "This orientation is part of a broader development in the field: pronunciation in foreign language teaching is increasingly being addressed explicitly in university-level teaching and research on Spanish phonetics and phonology. Pustka (2021) already includes a dedicated chapter on pronunciation in foreign language teaching at the beginning of her corpus-linguistic introduction; in the second, revised edition, Gabriel/Meisenburg/Selig (2025) add a new chapter on Spanish as a foreign language in the German-speaking context, with sections on segmental aspects and prosody. <em>Pronunciation Matters</em> builds on this development and complements it with a platform that makes controlled learner data available for empirical research and didactically oriented follow-up questions.",
        ...
        },
        {
            ...
            "bullets_html": {
                "de": [
                    "Bárkányi, Zsuzsanna / Galindo Merino, M. Mar / Pérez-Bernabeu, Aarón (Hg.) (2024): <em>La integración de la pronunciación en el aula de ELE</em>. Amsterdam/Philadelphia: John Benjamins. DOI: https://doi.org/10.1075/ivitra.42",
