...
SPANISH_DESIGN_PAGE_CONTENT: dict[str, object] = {
    ...
    "footnotes_html": {
        "de": [
            {
                "id": "fn-spanish-design-project-de",
                "label": "*",
        ...
        "en": [
            {
                "id": "fn-spanish-design-project-en",
                "label": "*",
