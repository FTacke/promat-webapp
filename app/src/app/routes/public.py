...
_SAMPLE_ADMONITION_VARIANTS: dict[str, dict[str, str]] = {
    ...
    "overview": {"title_key": "sample.admonitions.item.overview.title"},
...
def _sample_admonitions(ui_lang: str) -> list[dict[str, Any]]:
    return [
        ...
        _sample_admonition(ui_lang, "overview", "sample.admonitions.item.overview.body"),
        ...
        _sample_admonition(ui_lang, "weiterlesen", "sample.admonitions.item.weiterlesen.body"),
    ]
    ...
    return [
        {
            ...
            "meta_rows": [
                ...
                {"label": "Aufenthalte" if ui_lang == "de" else "Stays", "value": "Keine" if ui_lang == "de" else "None"},
            ],
            "profile_href": "#sample-research-profile-title",
        ...
        },
        {
            ...
            "meta_rows": [
                ...
                {"label": "L1", "value": "DE"},
                {"label": "Geschlecht" if ui_lang == "de" else "Gender", "value": "weiblich" if ui_lang == "de" else "female"},
                {"label": "Aufenthalte" if ui_lang == "de" else "Stays", "value": "Ja" if ui_lang == "de" else "Yes"},
            ],
            "profile_href": "#sample-research-profile-title",
            "profile_label": profile_label,
            "recordings_label": recordings_label,
        ...
        },
        {
            ...
            "meta_rows": [
                ...
                {"label": "Aufenthalte" if ui_lang == "de" else "Stays", "value": "Ja · 3,5 Monate" if ui_lang == "de" else "Yes · 3.5 months"},
            ],
            "profile_href": "#sample-research-profile-title",
            "profile_label": profile_label,
            "recordings_label": recordings_label,
