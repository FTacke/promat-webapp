# Project Pages Content: German and English

Dieses Dokument enthält die deutschen und englischen Inhalte für die allgemeinen Projektseiten von *Pronunciation Matters*. Die Texte sind für die öffentliche WebApp gedacht. Sprachspezifische Forschungsdetails bleiben in den jeweiligen Korpusbereichen unter Forschung.
...
| Seite DE | Seite EN | Route DE | Route EN | Empfohlener Template-Name | Funktion |
|---|---|---|---|---|---|
| Worum es geht | What this project is about | `/de/project/about` | `/en/project/about` | `project_about` | Einstieg, Projektidee, Entstehung, Video |
| Projektaufbau | Project structure | `/de/project/structure` | `/en/project/structure` | `project_structure` | Gesamtstruktur, Sprachkorpora, öffentliche und geschützte Bereiche |
| Daten & Methodik | Data & methods | `/de/project/data-methods` | `/en/project/data-methods` | `project_data_methods` | Datenerhebung, Audioaufbereitung, Annotation, WebApp-Funktionen |
| Team & Zusammenarbeit | Team & collaboration | `/de/project/team` | `/en/project/team` | `project_team` | Rollen, Beteiligte, Kooperationen, Dank |

Hinweis zur bestehenden Struktur: Die bisherige Projektseite `research-design` sollte auf Projektebene nicht weitergeführt werden, weil sie zu leicht mit den konkreten Forschungsdesigns der einzelnen Sprachkorpora verwechselt wird. Empfohlen ist, diese Seite durch `structure` zu ersetzen und alte Routen bei Bedarf sauber weiterzuleiten.

Note on the existing structure: The previous project page `research-design` should no longer be used at project level because it can easily be confused with the concrete research designs of the individual language corpora. The recommendation is to replace this page with `structure` and redirect old routes cleanly if necessary.

Hinweis zu `sample`: Die Sample-Seite ist eine Entwicklungs- und QA-Seite. Sie gehört nicht zur öffentlichen Inhaltsstruktur und wird in diesen Projektseiten nicht erwähnt.

Note on `sample`: The sample page is a development and QA page. It is not part of the public content structure and is not mentioned on these project pages.

Hinweis zur Darstellung: Der Projektname *Pronunciation Matters* soll in der WebApp kursiv gesetzt werden.

Display note: The project name *Pronunciation Matters* should be rendered in italics throughout the web app.
...
Route: `/de/project/about`  
Template: `project_about`  
Englischer Arbeitstitel: `What this project is about`

## Titel

Worum es geht

## Abschnitt 1: Aussprache als Forschungs- und Unterrichtsgegenstand
...
## Abschnitt 2: Vom Pilotprojekt zur mehrsprachigen Plattform
...
## Abschnitt 3: Lehre, Forschung und Transfer
...
## Abschnitt 4: Auszeichnung und Weiterentwicklung
...
## Medienblock: Projektvideo

Template-Hinweis: An dieser Stelle soll das Projektvideo als eingebettetes YouTube-Video erscheinen, nicht als bloßer Textlink.

Embed-Quelle: Das auf der Hispanistica-Seite eingebettete Video zu *Pronunciation Matters* übernehmen.  
Technische Referenzseite: `https://hispanistica.com/projects/promat/`

Vorgeschlagene Beschriftung unter dem Video:

Das Video stellt die Lehridee hinter *Pronunciation Matters* vor: die Verbindung von empirischer Ausspracheforschung, digitaler Plattformentwicklung, Hochschullehre und schulischem Transfer.

---

# Seite 2: Projektaufbau

Route: `/de/project/structure`  
Template: `project_structure`  
Englischer Arbeitstitel: `Project structure`

## Titel

Projektaufbau

## Abschnitt 1: Eine Plattform, mehrere Sprachkorpora
...
## Abschnitt 2: Bereiche der WebApp
...
## Abschnitt 3: Öffentliche Orientierung und geschützter Forschungszugang
...
## Abschnitt 4: Forschung und Unterricht als getrennte, aber verbundene Räume
...
## Abschnitt 5: Technische Grundlage als Teil der Projektidee
...
# Seite 3: Daten & Methodik

Route: `/de/project/data-methods`  
Template: `project_data_methods`  
Englischer Arbeitstitel: `Data & methods`

## Titel

Daten & Methodik

## Abschnitt 1: Welche Daten entstehen
...
## Abschnitt 3: Lernendengerechte Item-Auswahl
...
## Abschnitt 4: Audioaufbereitung und Annotation
...
## Abschnitt 5: Interviewtranskription
...
## Abschnitt 6: Intake, Pseudonymisierung und Datenintegration
...
## Abschnitt 7: WebApp als Forschungsinstrument
...
## Abschnitt 8: Zugriff, Schutz und Veröffentlichung
...
# Seite 4: Team & Zusammenarbeit

Route: `/de/project/team`  
Template: `project_team`  
Englischer Arbeitstitel: `Team & collaboration`

## Titel

Team & Zusammenarbeit

## Abschnitt 1: Gesamtprojekt

Die Gesamtprojektleitung liegt bei Prof. Dr. Felix Tacke. Dazu gehören die übergreifende Konzeption von *Pronunciation Matters*, der mehrsprachige Plattformaufbau, die Weiterentwicklung des spanischen Pilotansatzes sowie die Verbindung von Forschung, Hochschullehre und schulischem Transfer. Auch Datenmodellierung, Datenmanagement, Forschungsdatenstruktur, Webdesign und WebApp-Programmierung wurden in diesem Bereich umgesetzt.

Die ausführende Koordination übernimmt Marlon Merte. Er begleitet die operativen Abläufe, unterstützt die Aufnahmeprozesse und wirkt an der praktischen Umsetzung der Korpusarbeit mit, insbesondere in den Bereichen Spanisch und Englisch.

So wurde *Pronunciation Matters* nicht nur als Projektseite, sondern als digitales Arbeitsinstrument für Forschung, Hochschullehre und Unterricht aufgebaut.

## Abschnitt 2: Sprachkorpora und Verantwortlichkeiten

Die Sprachkorpora werden von den jeweiligen Fachvertreter:innen verantwortet. Dadurch können die einzelnen Korpora eigene sprach- und fachdidaktische Schwerpunkte setzen, während sie zugleich Teil einer gemeinsamen Plattformstruktur bleiben.

| Korpus | Korpusverantwortung | Materialkonzeption | Durchführung |
|---|---|---|---|
| Spanisch-Korpus | Prof. Dr. Felix Tacke | Prof. Dr. Felix Tacke, Ana Goás Pérez | Marlon Merte |
| Französisch-Korpus | Prof. Dr. Janina Reinhardt | Prof. Dr. Janina Reinhardt | Amelie Spieß |
| Deutsch-Korpus | Prof. Dr. Kathrin Siebold | Prof. Dr. Kathrin Siebold | Theresa Fischer, M.A. |
| Englisch-Korpus | Prof. Dr. Rolf Kreyer | Prof. Dr. Rolf Kreyer | Marlon Merte |

## Abschnitt 3: Kooperation mit dem Sprachenzentrum

*Pronunciation Matters* arbeitet mit dem Sprachenzentrum der Philipps-Universität Marburg zusammen. Das Sprachenzentrum ist für das Projekt ein wichtiger Ort, weil das Fremdsprachenlernen dort eine eigene institutionelle Praxis auf dem Campus hat und Lernende verschiedener Zielsprachen erreicht werden können. Für die Gewinnung von Teilnehmenden und die Durchführung von Aufnahmen war diese Zusammenarbeit besonders wichtig.

Teilnehmende wurden sowohl über die beteiligten Institute als auch über Lernende des Sprachenzentrums gewonnen.
...
## Abschnitt 4: Dank an Teilnehmende und Referenzsprecher:innen

*Pronunciation Matters* dankt allen Studierenden und weiteren Teilnehmenden, die ihre Sprachdaten für das Projekt zur Verfügung gestellt haben. Ohne ihre Bereitschaft, an den Aufnahmen mitzuwirken und die Nutzung ihrer Daten für Forschung und Lehre zu ermöglichen, könnten die Sprachkorpora nicht aufgebaut werden.

Besonderer Dank gilt außerdem den Personen, die ihre Stimme als Referenzsprecher:innen zur Verfügung gestellt haben. Ihre Aufnahmen bilden in den jeweiligen Sprachen wichtige Standardaussprachen ab und ermöglichen Vergleichsperspektiven, die für Forschung und Lehre zentral sind. Referenzaufnahmen dienen dabei nicht als eigenes Untersuchungsobjekt und auch nicht als einfache Norm, an der Lernende gemessen werden. Sie stellen vielmehr ein tertium comparationis bereit: Lernendenaussprache und Zielaussprache können anhand derselben Items akustisch nachvollziehbar miteinander verglichen werden.
...
*Pronunciation Matters* versteht Studierende nicht nur als Zielgruppe, sondern auch als Beteiligte. In Lehrveranstaltungen arbeiten sie mit den entstehenden Daten, reflektieren methodische Entscheidungen und entwickeln teilweise Materialien für Schule und Lehre mit.

Das betrifft mehrere Ebenen. Studierende können nachvollziehen, wie Forschungsdaten entstehen, wie Aufnahmen vorbereitet und analysiert werden und welche Entscheidungen für ein aussprachebezogenes Korpus nötig sind. Zugleich können sie an der didaktischen Aufbereitung mitwirken, indem sie Materialien, Aufgaben oder erklärende Texte für Unterrichtskontexte konzipieren und verfassen.

Dadurch entsteht ein Lehrformat, in dem fachwissenschaftliche Analyse, digitale Methoden und Vermittlungskompetenz zusammenkommen. Die Arbeit an *Pronunciation Matters* ist damit nicht nur Projektarbeit im Hintergrund, sondern Teil einer forschungsnahen und produktorientierten Hochschullehre.
...
# Page 1: What this project is about

Route: `/en/project/about`  
Template: `project_about`  
German title: `Worum es geht`

## Title

What this project is about

## Section 1: Pronunciation as a subject of research and teaching
...
## Section 2: From a pilot project to a multilingual platform
...
## Section 3: Teaching, research, and transfer
...
## Section 4: Award and further development
...
## Media block: Project video

Template note: The project video should be embedded here as a YouTube video, not provided merely as a text link.

Embed source: Use the video embedded on the Hispanistica page for *Pronunciation Matters*.  
Technical reference page: `https://hispanistica.com/projects/promat/`

Suggested caption below the video:

The video presents the teaching idea behind *Pronunciation Matters*: the connection between empirical pronunciation research, digital platform development, university teaching, and transfer to school contexts.

---

# Page 2: Project structure

Route: `/en/project/structure`  
Template: `project_structure`  
German title: `Projektaufbau`

## Title

Project structure

## Section 1: One platform, several language corpora
...
## Section 2: Areas of the web app
...
## Section 3: Public orientation and protected research access
...
## Section 4: Research and teaching as separate but connected spaces
...
## Section 5: Technical infrastructure as part of the project idea
...
Route: `/en/project/data-methods`  
Template: `project_data_methods`  
German title: `Daten & Methodik`

## Title

Data & methods

## Section 1: What data is produced
...
## Section 3: Learner-oriented item selection
...
## Section 4: Audio processing and annotation
...
## Section 5: Interview transcription
...
## Section 6: Intake, pseudonymisation, and data integration
...
## Section 7: The web app as a research instrument
...
## Section 8: Access, protection, and publication
...
# Page 4: Team & collaboration

Route: `/en/project/team`  
Template: `project_team`  
German title: `Team & Zusammenarbeit`

## Title

Team & collaboration

## Section 1: Overall project

The overall project lead is Prof. Dr. Felix Tacke. This includes the overarching conception of *Pronunciation Matters*, the development of the multilingual platform, the further development of the Spanish pilot approach, and the connection between research, university teaching, and transfer to school contexts. Data modelling, data management, research data structure, web design, and web app programming were also implemented in this area.

The executive coordination is carried out by Marlon Merte. He accompanies the operative workflows, supports the recording processes, and contributes to the practical implementation of the corpus work, especially in the Spanish and English areas.

In this way, *Pronunciation Matters* was built not only as a project website, but as a digital working instrument for research, university teaching, and school contexts.

## Section 2: Language corpora and responsibilities

The language corpora are the responsibility of the respective subject representatives. This allows the individual corpora to set their own linguistic and didactic priorities while remaining part of a shared platform structure.

| Corpus | Corpus responsibility | Material design | Implementation |
|---|---|---|---|
| Spanish corpus | Prof. Dr. Felix Tacke | Prof. Dr. Felix Tacke, Ana Goás Pérez | Marlon Merte |
| French corpus | Prof. Dr. Janina Reinhardt | Prof. Dr. Janina Reinhardt | Amelie Spieß |
| German corpus | Prof. Dr. Kathrin Siebold | Prof. Dr. Kathrin Siebold | Theresa Fischer, M.A. |
| English corpus | Prof. Dr. Rolf Kreyer | Prof. Dr. Rolf Kreyer | Marlon Merte |

## Section 3: Cooperation with the Language Center

*Pronunciation Matters* cooperates with the Language Center of Philipps-Universität Marburg. The Language Center is important for the project because it provides foreign language learning with its own institutional place on campus and makes it possible to reach learners of different target languages. This cooperation was especially important for recruiting participants and carrying out recordings.

Participants were recruited both through the participating institutes and through learners at the Language Center.
...
## Section 4: Thanks to participants and reference speakers

*Pronunciation Matters* thanks all students and other participants who made their speech data available to the project. Without their willingness to take part in the recordings and to make the use of their data possible for research and teaching, the language corpora could not be built.

Special thanks also go to the people who provided their voices as reference speakers. Their recordings represent important standard pronunciations in the respective languages and make possible comparison perspectives that are central for research and teaching. Reference recordings do not serve as an independent object of investigation, nor as a simple norm against which learners are measured. Rather, they provide a tertium comparationis: learner pronunciation and target pronunciation can be compared acoustically and transparently using the same items.
...
*Pronunciation Matters* understands students not only as a target group, but also as participants in the project. In courses, they work with the emerging data, reflect on methodological decisions, and in some cases help develop materials for school and university teaching.

This concerns several levels. Students can understand how research data is created, how recordings are prepared and analysed, and which decisions are necessary for a pronunciation-related corpus. At the same time, they can contribute to didactic preparation by designing and writing materials, tasks, or explanatory texts for teaching contexts.

This creates a teaching format in which subject-specific analysis, digital methods, and mediation skills come together. Work on *Pronunciation Matters* is therefore not merely project work in the background, but part of research-based and product-oriented university teaching.

---

# Implementierungshinweise für den Repo-Agent

Die folgenden Hinweise sind nicht als sichtbarer Seitentext gedacht, sondern als technische Orientierung für die spätere Umsetzung.

## Navigation

Empfohlene Projektseiten-Reihenfolge:

1. `about` → Worum es geht / What this project is about
2. `structure` → Projektaufbau / Project structure
3. `data-methods` → Daten & Methodik / Data & methods
4. `team` → Team & Zusammenarbeit / Team & collaboration

Die bestehende Seite `research-design` sollte nicht weiter als sichtbare Projektseite verwendet werden. Falls die Route bereits existiert, sollte sie entweder ersetzt oder auf `structure` weitergeleitet werden.

The existing `research-design` page should no longer be used as a visible project page. If the route already exists, it should either be replaced or redirected to `structure`.

## Untertitel

Untertitel sollen auf den Projektseiten weggelassen werden.

Subtitles should be omitted on the project pages.

## YouTube-Embed

Auf `/de/project/about` und `/en/project/about` soll das Projektvideo eingebettet werden. Die Embed-Quelle ist auf der Hispanistica-Projektseite zu finden:

`https://hispanistica.com/projects/promat/`

Das Video soll im Seitenfluss nach dem Abschnitt zur Auszeichnung und Weiterentwicklung erscheinen.

The project video should be embedded on `/de/project/about` and `/en/project/about`. The embed source can be taken from the Hispanistica project page:

`https://hispanistica.com/projects/promat/`

The video should appear in the page flow after the section on the award and further development.

## Kursivsetzung des Projektnamens

Der Projektname *Pronunciation Matters* soll in sichtbaren Fließtexten kursiv gesetzt werden.

The project name *Pronunciation Matters* should be rendered in italics in visible body text.

## Öffentliche und geschützte Bereiche

In den Projekttexten wird nicht von einem internen Adminbereich gesprochen. Öffentlich relevant ist nur die Unterscheidung zwischen:

- öffentlich zugänglichen Projektinformationen, Designbeschreibungen und freigegebenen Materialien
- geschützten Forschungsdaten und Arbeitsoberflächen für berechtigte Nutzer:innen aus Forschungs- und Bildungseinrichtungen

The project texts should not refer to an internal admin area. The public distinction is only between:

- publicly accessible project information, design descriptions, and released materials
- protected research data and work surfaces for authorised users from research and educational institutions

## Begriffe, die vermieden werden sollten

Nicht pauschal verwenden:
...
- kontrollierte Audioaufbereitung
- Praat-Annotation
- Forced Alignment mit Montreal Forced Aligner
- redaktionell bearbeitete Interviewtranskripte
- skriptgestützte Integration in die WebApp
- geschützter Forschungszugang

Terms to avoid as general descriptions:
...
- editorially reviewed interview transcripts
- script-based integration into the web app
